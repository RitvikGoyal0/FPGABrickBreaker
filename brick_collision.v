module brick_collision #(
    ...
    input signed [ 10:0] potent_pos_x,
    input signed [  9:0] potent_pos_y,
  ...
  wire [4:0] col_x = (colliding_edge_x - FIRST_COL_X) >> 5;
  ...
  wire [4:0] col_y = (potent_pos_x - FIRST_COL_X) >> 5;
  ...
  // wire [4:0] col_d = (colliding_edge_d_x - FIRST_COL_X) >> 5;
